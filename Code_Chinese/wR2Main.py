...
# If using colab, uncomment the following chunk of code:
    wR2Path = './weight/wR2_Atulya_epoch_11.pth'
    images = './ccpd_dataset/ccpd_weather'
    testDir = images.split(',')
    dstrectangleDir = './ccpd_weather_rectangle/'
    writeIousInFile = './wR2MainIoUOutput/IoU.out'
    ...
    dst = ChaLocDataLoader(testDir, imgSize)
