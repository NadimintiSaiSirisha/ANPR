...
#[leftUp, rightDown] = [[int(eel) for eel in el.split('&')] for el in iname[2].split('_')]  # Corresponding to the coordinates of the upper left corner and the lower right corner
